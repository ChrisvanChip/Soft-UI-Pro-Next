    ...
    <div class="profile-profile">
      ...
      <div class="profile-container01">
        <div class="profile-container02">
          <h4 class="profile-text">Michael Roven</h4>
          <outline-blue-button button="follow"></outline-blue-button>
        </div>
        <div class="profile-container03">
          <span class="profile-text01">
            <span class="profile-text02">323</span>
            <span>Posts</span>
          </span>
          <span class="profile-text04">
            <span class="profile-text05">3.5k</span>
            <span>Followers</span>
          </span>
          <span>
            <span class="profile-text08">260</span>
            <span>Following</span>
          </span>
        </div>
        <span class="medium">
        ...
        <next-button button="More about me"></next-button>
      </div>
    </div>
    <div class="profile-blog-posts">
      <h1 class="profile-text11 headingTwo">
        <span></span>
        ...
        <div class="profile-container05">
          <div class="profile-card">
            <div class="profile-container06">
              <h1 class="profile-text14">Flexible work hours</h1>
              <span class="profile-text15">
                <span class="profile-text16">
              ...
              <div class="profile-container07">
                <button class="profile-button button">
                  <span class="profile-text17">Read more</span>
            ...
            <div class="profile-container08"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="profile-contact">
      <div class="profile-container09">
        <div class="profile-form">
          <h2 class="profile-text18 headingOne"><span>Say Hi!</span></h2>
          <span class="profile-text20 lead">
            We&apos;d like to talk with you.
          </span>
          <form class="profile-form1">
            <label class="profile-text21 label">My name is</label>
            <input
              type="text"
              placeholder="Full Name"
              class="profile-textinput small input"
            />
            <label class="profile-text22 label">I&apos;m looking for</label>
            <input
              type="text"
              placeholder="What you love"
              class="profile-textinput1 small input"
            />
            <label class="profile-text23 label">Your message</label>
            <textarea
              rows="8"
              placeholder="I want to say that..."
              class="profile-textarea textarea small"
            ></textarea>
          </form>
          <div class="profile-container10">
            <div class="profile-container11">
              <primary-blue-button button="send message"></primary-blue-button>
            </div>
          </div>
        </div>
